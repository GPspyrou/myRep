...
export default function HomeHeroSection({ houses }: Props) {
  ...
  // price buckets with numeric values for query params
  const priceOptions = [
            ...
            return (
              <SwiperSlide key={house.id}>
                <div className="relative w-full h-full overflow-hidden">
                  ...
                  <div className="absolute bottom-20 sm:bottom-4 left-4 right-4 flex flex-col sm:flex-row justify-between items-start sm:items-center text-white z-10 space-y-2 sm:space-y-0">
                    <div>
